    ...
    <main className="container py-8 pb-36 md:py-16 md:pb-20">
      <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-bold md:text-6xl">Room 101</h1>
          <p className="mt-3 flex items-center gap-2 text-gray-400">
            <MapPin className="h-4 w-4 text-gold" /> V. Felidhoo, Maldives
          </p>
        </div>
        <Link
          href="/booking?property=Uhoo%27s%20Lavish%20Oasis&roomType=ROOM%20101&mealPlan=Bed%20%26%20Breakfast"
            ...
            >
              ...
              {index === 0 && (
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-4 pt-12 md:p-5 md:pt-16">
                  ...
                  <p className="mt-1 text-sm font-medium text-white">Room 101 · Private room for two</p>
                </div>
              )}
            </div>
          ))}
      ...
      <div className="mt-10 grid gap-8 lg:mt-12 lg:grid-cols-[1.1fr_.9fr]">
        <section>
          <div className="flex items-start gap-3">
            ...
            <h2 className="text-2xl font-bold leading-tight md:text-3xl">A private island room for two</h2>
          </div>
          <p className="mt-4 leading-7 text-gray-400">
            A comfortable double room at Uhoo&apos;s Lavish Oasis with flexible meal plans and Tripelor booking support.
          </p>
        ...
        <AvailabilityChecker roomType="ROOM 101" />
      </div>
    </main>
  );
}

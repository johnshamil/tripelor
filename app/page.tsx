...
const stays = [
  {
    ...
    description: "Comfortable rooms, warm island hospitality and flexible meal plans for a relaxed Felidhoo getaway.",
  ...
  },
  {
    ...
    description: "A comfortable local island guesthouse stay with flexible meal plans and friendly Maldivian hospitality.",
...
export default function Home() {
  return <>
    <section className="relative min-h-[78vh] overflow-hidden"><Image src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=2200&auto=format&fit=crop" alt="Luxury tropical destination" fill priority className="object-cover"/><div className="absolute inset-0 bg-gradient-to-r from-black via-black/70 to-black/20"/><div className="container relative flex min-h-[78vh] items-center"><div className="max-w-3xl py-24"><p className="mb-4 text-sm font-semibold uppercase tracking-[0.35em] text-gold">Discover. Escape. Remember.</p><h1 className="text-5xl font-bold leading-tight md:text-7xl">Travel beautifully with <span className="text-gold">Tripelor</span></h1><p className="mt-6 max-w-2xl text-lg text-gray-200">Relaxing island stays and memorable experiences, thoughtfully arranged for you.</p><Link href="/booking" className="btn-gold mt-8">Book Your Stay</Link></div></div></section>
    ...
    <section className="border-b border-white/10 bg-white/[0.02]"><div className="container grid gap-8 py-16 md:grid-cols-3"><div className="card p-6"><Sparkles className="h-8 w-8 text-gold"/><h3 className="mt-4 text-xl font-semibold">Curated for you</h3><p className="mt-2 text-gray-400">Comfortable island stays tailored to your dates and meal preference.</p></div><div className="card p-6"><Globe2 className="h-8 w-8 text-gold"/><h3 className="mt-4 text-xl font-semibold">Local island experience</h3><p className="mt-2 text-gray-400">Experience authentic Maldivian island life and hospitality.</p></div><div className="card p-6"><ShieldCheck className="h-8 w-8 text-gold"/><h3 className="mt-4 text-xl font-semibold">Trusted support</h3><p className="mt-2 text-gray-400">Personal guidance before, during, and after your stay.</p></div></div></section>
    <section className="container py-20 text-center"><p className="text-sm uppercase tracking-[0.3em] text-gold">Your island escape</p><h2 className="mx-auto mt-3 max-w-3xl text-4xl font-bold md:text-5xl">Choose your stay and start planning your Maldives escape.</h2><Link href="/booking" className="btn-gold mt-8">Book Your Stay</Link></section>
  </>;
}

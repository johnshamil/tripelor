...
export const properties:TripelorProperty[] = [
  ...
  },
  {
    ...
    description:"A comfortable local-island guesthouse with six rooms and flexible meal plans.",startingFrom:97,currency:"USD",bookingMode:"instant",roomsLabel:"6 rooms",
    rates:[{label:"Bed & Breakfast",price:97},{label:"Half Board",price:110},{label:"Full Board",price:130}],
  },
  {
    ...
    rates:[
      ...
      {label:"Deluxe Twin · RO",price:70,note:"SGL"},{label:"Deluxe Twin · BB",price:80,note:"SGL"},{label:"Deluxe Twin · HB",price:100,note:"SGL"},{label:"Deluxe Twin · FB",price:120,note:"SGL"},
      {label:"Deluxe Twin · RO",price:80,note:"DBL"},{label:"Deluxe Twin · BB",price:90,note:"DBL"},{label:"Deluxe Twin · HB",price:130,note:"DBL"},{label:"Deluxe Twin · FB",price:170,note:"DBL"},
      {label:"Sea View · RO",price:100,note:"SGL"},{label:"Sea View · BB",price:110,note:"SGL"},{label:"Sea View · HB",price:130,note:"SGL"},{label:"Sea View · FB",price:150,note:"SGL"},
      {label:"Sea View · RO",price:110,note:"DBL"},{label:"Sea View · BB",price:120,note:"DBL"},{label:"Sea View · HB",price:160,note:"DBL"},{label:"Sea View · FB",price:190,note:"DBL"}
    ],
  },
];
